          ...
          <form action="#" class="contact-form">
            ...
            <div class="row">
              <div class="col-md-12 mb-5">
                <h3>
                  <img :src="userAvatar" :alt="userFullName" /> Hola
                  {{ userData.firstname }}
                </h3>
              </div>
              <div class="col-md-6">
      ...
      <div v-for="order in userOrders" :key="order._id" class="row">
        <div class="col-md-12 mb-1">
          <div class="row order-item-header">
            ...
            <div class="col-md-4">
              {{ createDateFromString(order.created_at) | toDate }}
            </div>
        ...
        <div class="col-md-12 mb-3">
          ...
          >
            ...
            <div class="col-md-2">
              {{ (product.quantity * product.price) | toMoney }}
            </div>
          </div>
...
export default {
  ...
  async asyncData(context){
    let currentUser = context.store.state.user;
    ...
    const orderList = await context.$axios.$get(
  ...
  computed: {
    ...
    userAvatar() {
      if (this.$store.state.user === null || !this.$store.state.user.hasOwnProperty("avatar")) {
        return "";
      }
  ...
  methods: {
    async loadCurrentUserData() {
      ...
      try {
        ...
        this.userData.phone = result.phone;
    ...
    async update() {
      ...
      try {
        ...
        alert(
          "Se ha producido un error al registrar el usuario. Revisa los datos introducidos."
        );
      }
    },
    logout() {
    ...
    async loadCurrentUserOrders() {
      ...
      try {
        ...
        alert("No se ha podido obtener la información de los pedidos");
      }
    },
